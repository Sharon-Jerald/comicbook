...
<form action="/requestdeleteprocess/{{ $rbooks->id }}" method="post" >
...
<tr>
 ...
 <tr>
     <td> Name </td>
     <td>
      <input value="{{   $rbooks->rbname }}" name="bname" type="text" class="form-control">
     </td>
 </tr>
 <tr>
     <td>Author</td>
     <td>       <input value="{{   $rbooks->rbauthor}}" name="bauthor" type="text" class="form-control">
</td>
 </tr>

 <tr>
     <td>Publisher </td>
     <td>      <input value="{{   $rbooks->rbpublisher}}" name="bpublisher" type="text" class="form-control">
</td>
 </tr>
 <tr>
     <td>Quantity</td>
     <td>      <input value="{{   $rbooks->rbqty}}" name="bgenre" type="text" class="form-control">
</td>
 </tr>
 <tr>
     <td></td>
