        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid3">
                <div class="product-image3">
                    <a href="#">
                        <img class="pic-1" src="{{ URL ::asset('assets/book_img/'.$book->bimage) }}">
                        <img class="pic-2" src="{{ URL ::asset('assets/book_img/'.$book->bimage) }}">
                    </a>
                    <ul class="social">
                        
                        <li><a  href={{"/productdetails/".$book->id}}><i class="fa fa-shopping-cart"></i></a></li>
                    </ul>
                    <span class="product-new-label">New</span>
                </div>
                <div class="product-content">
                    <h2 class="title"><a href="#">{{ $book->bname }}</a></h2>
                    
                    <h2 class="title">Rs.{{ $book->bprice }}</h2>   
	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				...
				<a href={{"/deleterequest/".$book->id}}>Confirm</a>
			</div>
		</div>
	</div>
</div>    
