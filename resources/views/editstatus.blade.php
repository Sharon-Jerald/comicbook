    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown  active"><a href="#"><span>Orders</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
...
<form action="/statuseditprocess/{{ $orders->id }}" method="post">
...
<tr>
        ...
        <td><input  value="{{   $orders->ostatus }}" ></td>
    </tr>
    <tr>
        <td>New Status:</td>
        <td><input type="text" name="ostatus"  class="form-control"></td>
    </tr>
    <tr>
